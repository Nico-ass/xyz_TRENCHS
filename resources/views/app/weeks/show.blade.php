                            ...
                            <div class="details">
                                ...
                                <div class="metadata">
                                    ...
                                    <div class="metadata-item">
                                        ...
                                        <span>{{ $track->category ? $track->category->name : __('tracks.no_category') }}</span>
                                    </div>
                                    <div class="metadata-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <div>
            <div class="block block-content space-y-8">
                @if($isCurrent)
                    ...
                    <div class="space-y-2">
                        ...
                        @can('create', App\Models\Track::class)
                            <a class="button button-primary" href="{{ route('app.tracks.create', ['week' => $week->uri]) }}">
                ...
                @else
                    <div class="title">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75S21.75 6.615 21.75 12s-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm9.25 3.75c.414 0 .75.336.75.75s-.336.75-.75.75a3.75 3.75 0 0 1-3.75-3.75.75.75 0 0 1 1.5 0c0 1.035.84 1.875 1.875 1.875Zm.75-11.25a.75.75 0 0 1-.75.75c-1.035 0-1.875.84-1.875 1.875a.75.75 0 0 1-1.5 0C9.75 5.336 11.086 4 12.75 4c.414 0 .75.336.75.75Z" clip-rule="evenodd" />
                        </svg>
                        <div>
                            <h1>Terminé</h1>
                            <h2>{{ $week->name }}</h2>
                    ...
                    <p>
                        Les contributions pour la semaine {{ $week->weekNumber }} sont terminées.
                    </p>
                @endif
            </div>
        </div>
